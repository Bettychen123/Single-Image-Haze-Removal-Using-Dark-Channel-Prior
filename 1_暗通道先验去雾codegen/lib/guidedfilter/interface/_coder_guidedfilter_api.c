/*
 * File: _coder_guidedfilter_api.c
 *
...
static real32_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *r, const
  char_T *identifier);
 ...
 * Return Type  : void
 */
void guidedfilter_api(const mxArray * const prhs[4], int32_T nlhs, const mxArray
                      *plhs[1])
{
  emxArray_real_T *b_I;
  emxArray_real_T *p;
  ...
  p->canFreeData = false;
  emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "p", p);
  r = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "r");
  eps = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "eps");

  /* Invoke the target function */
  guidedfilter(b_I, p, r, eps, q);
...
void guidedfilter_atexit(void)
{
  ...
  guidedfilter_xil_terminate();
  guidedfilter_xil_shutdown();
 ...
 * Return Type  : void
 */
void guidedfilter_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void guidedfilter_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_guidedfilter_api.c
 *
 * [EOF]
 */
